  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="<?php echo base_url('PageHome')?>" class="list-group-item list-group-item-action bg-light">Dashboard</a>
        <a href="<?php echo base_url('Jabatan')?>" class="list-group-item list-group-item-action bg-light">Data Jabatan</a>
        <a href="<?php echo base_url('Karyawan')?>" class="list-group-item list-group-item-action bg-light">Data Karyawan</a>
        <a href="<?php echo base_url('Pengguna')?>" class="list-group-item list-group-item-action bg-light">Data Pengguna</a>
        <a href="<?php echo base_url('Laporan')?>" class="list-group-item list-group-item-action bg-light">Laporan Penggajian</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
